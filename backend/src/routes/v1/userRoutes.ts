...
const userRoutes: FastifyPluginAsync = async (app) => {
  ...
  // PATCH /data/users/:id/role — Admin + SuperAdmin: change role (RBAC enforced in controller)
  app.patch("/:id/role", { preHandler: [authenticate as any, requireAdmin as any] }, updateRole);

  // DELETE /data/users/:id   — SuperAdmin: delete any user; Admin: only can delete USERs
  app.delete("/:id", { preHandler: [authenticate as any, requireAdmin as any] }, deleteUser);
};

...
export const Route = createFileRoute("/table/$tableNumber")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Start a dine-in order for your table at Maa Tara Sweets.",
      },
...
function TableEntry() {
  ...
  useEffect(() => {
    ...
    void navigate({ to: "/menu", search: { category: undefined }, replace: true });
    ...
    <main className="grid min-h-[70vh] place-items-center px-4">
      <div className="glass animate-rise rounded-3xl px-10 py-12 text-center">
        ...
        <h1 className="mt-6 font-display text-2xl font-bold">
          Table {tableNumber} connected
        </h1>
        <p className="mt-2 text-sm text-muted-foreground">
          Opening the menu for your table…
        </p>
      </div>
    </main>
  );
